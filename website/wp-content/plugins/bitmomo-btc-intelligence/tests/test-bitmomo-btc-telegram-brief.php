...
Bitmomo_Public_Intelligence_Adapter::$fixture = $fresh;
check_telegram_brief( 'current() delegates to the canonical public adapter and returns exactly the publishable text', Bitmomo_Btc_Telegram_Brief::current() === $text );
...
Bitmomo_Public_Intelligence_Adapter::$fixture = $delayed;
check_telegram_brief( 'current() returns empty text when canonical intelligence is delayed', '' === Bitmomo_Btc_Telegram_Brief::current() );
