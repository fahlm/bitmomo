 ...
 *
 * Presentation-only: this class consumes the same public-safe adapter used by
 * /btc-intelligence/ and never calculates a second market opinion or reads
 * protected Pro fields.
 */
final class Bitmomo_Btc_Telegram_Brief {
	...
	/** Return the current publishable public-safe brief text, or an empty string. */
	public static function current( $cta_url = self::DEFAULT_CTA_URL ) {
		$result = self::build( null, $cta_url );
