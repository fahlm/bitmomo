 ...
 *
 * Telegram capability is loaded but dormant:
 * - Bitmomo_Btc_Telegram_Brief owns public-safe Telegram text.
 * - Bitmomo_Btc_Telegram_Transport owns delivery to @bitmomodaily.
 * - no schedule/hook sends a message automatically in this release slice;
 * - delivery additionally fails closed unless runtime configuration explicitly
 *   enables it and supplies the bot token outside the repository.
 */
