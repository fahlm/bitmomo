...
define( 'BITMOMO_PRO_VERSION', '0.1.0' );
...
/**
 * Bootstraps the plugin's three responsibilities:
 ...
 * - Shortcodes: the front-end rendering surface, gated server-side.
 *
 ...
 * Bitmomo_Pro_Shortcodes::checkout_cta().
 */
...
function bitmomo_pro_render_checkout_url_field() {
	...
	printf(
		...
		esc_attr( $value ),
		esc_html__( 'Where the Bitmomo Pro CTA points. Leave blank until a payment path is finalized — the CTA hides gracefully and shows a manual-activation note instead.', 'bitmomo-pro' )
	);
}
