		...
		return array(
			...
			'ai-analysts-watchtower' => array(
				...
				'items' => array(
					...
					self::q( 'apakah-analysts-tersedia', 'Apakah 11 AI Analysts sudah tersedia?', array( 'Belum.', '11 AI Analysts masih dalam pengembangan.', 'Ketika tersedia, sistem ini dirancang untuk memberikan berbagai perspektif spesialis pada scheduled intelligence Bitmomo.' ), 'SEGERA HADIR' ),
					self::q( 'apa-itu-watchtower', 'Apa itu Bitmomo Watchtower?', array( 'Watchtower adalah monitoring layer Bitmomo yang sedang dikembangkan untuk mendeteksi perubahan penting di antara scheduled intelligence updates.', 'Tujuannya adalah membantu menjaga thesis Bitmomo tetap relevan ketika kondisi pasar berubah.' ), 'SEGERA HADIR' ),
