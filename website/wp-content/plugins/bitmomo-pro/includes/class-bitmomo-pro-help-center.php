		...
		return array(
			...
			'market-state-intelligence' => array(
				...
				'items' => array(
					...
					self::q( 'market-state-30-hari', 'Apa itu Market State 30 Hari?', array( 'Market State 30 Hari menampilkan riwayat Market State yang benar-benar tercatat oleh Bitmomo.', 'Setiap tanggal hanya memiliki satu Market State resmi dalam riwayat publik sehingga perubahan kondisi pasar dapat ditelusuri dari waktu ke waktu.' ) ),
					self::q( 'history-belum-30-hari', 'Mengapa riwayat Market State belum selalu berisi 30 hari?', array( 'Bitmomo tidak melakukan backfill retrospektif hanya untuk melengkapi visualisasi.', 'Jika baru tujuh hari yang benar-benar tercatat, Bitmomo akan menampilkan:', '“7 / 30 hari tercatat”', 'Riwayat akan bertambah secara bertahap seiring sistem mencatat Market State baru.' ) ),
				),
			),
			'bitmomo-pro' => array(
				'title' => 'Bitmomo Pro',
				'items' => array(
					self::q( 'apa-itu-bitmomo-pro', 'Apa itu Bitmomo Pro?', array( 'Bitmomo Pro adalah layanan decision support untuk BTC yang membantu menavigasi apa yang mungkin terjadi berikutnya dan kapan tesis utama perlu dievaluasi ulang.', 'Pro melengkapi BTC Intelligence gratis dengan monitoring lengkap, Expected Range, Scenario Map, kondisi invalidasi tesis, dan konteks Confidence yang lebih dalam.' ) ),
					self::q( 'free-vs-pro', 'Apa bedanya BTC Intelligence gratis dengan Bitmomo Pro?', array( 'BTC Intelligence gratis sudah cukup untuk memahami kondisi sekarang, perubahan material, mengapa perubahan itu penting, dan satu konteks yang layak dipantau.', 'Bitmomo Pro menambahkan seluruh monitoring/watch set, Expected Range, skenario Base/Bull/Bear, level keputusan, dan kondisi invalidasi untuk membantu menavigasi apa yang terjadi berikutnya.' ) ),
					...
					self::q( 'apa-itu-what-changed', 'Apa itu What Changed?', array( 'What Changed menunjukkan perubahan penting dibanding pembacaan sebelumnya.', 'Versi gratis menampilkan perubahan material secara ringkas. Pro menggunakannya bersama skenario, monitoring lengkap, level, dan invalidasi sehingga perubahan tersebut dapat dibaca dalam konteks decision support.' ) ),
				),
			),
			'founding-membership-pricing' => array(
				...
				'items' => array(
					...
					self::q( 'semua-produk-masa-depan', 'Apakah Founding Members mendapatkan semua produk Bitmomo di masa depan?', array( 'Tidak.', 'Manfaat Founding Membership berlaku untuk fitur baru yang ditambahkan ke Bitmomo Pro, termasuk 11 AI Analysts dan Watchtower jika diluncurkan sebagai bagian dari Bitmomo Pro.', 'Produk Bitmomo yang terpisah di masa depan dapat memiliki harga tersendiri.' ) ),
