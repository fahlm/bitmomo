		...
		return array(
			...
			'btc-daily-intelligence' => array(
				...
				'items' => array(
					...
					self::q( 'jadwal-btc-daily-intelligence', 'Seberapa sering BTC Intelligence diperbarui?', array( 'BTC Intelligence dijadwalkan dua kali sehari:', '<strong>Morning Intelligence</strong> — sekitar 07.10 WIB<br><strong>US Session Intelligence</strong> — sekitar 19.10 WIB', 'Jadwal adalah target operasional. Analisis terbaru hanya ditampilkan jika data memenuhi standar kualitas Bitmomo.' ) ),
					self::q( 'mengapa-dua-kali-sehari', 'Kenapa Bitmomo memperbarui BTC Intelligence dua kali sehari?', array( 'Kedua update memiliki fungsi yang berbeda.', 'Morning Intelligence merangkum kondisi BTC setelah pergerakan semalam dan perubahan dibanding US Session sebelumnya.', 'US Session Intelligence memberikan kondisi BTC terbaru menjelang periode penting sesi AS dan membandingkannya dengan kondisi pagi.', 'Di antara jadwal analisis tersebut, Watchtower direncanakan sebagai sistem monitoring tambahan dan belum tersedia saat ini.' ) ),
			...
			'bitmomo-pro' => array(
				'title' => 'Bitmomo Pro',
				'items' => array(
					self::q( 'apa-itu-bitmomo-pro', 'Apa itu Bitmomo Pro?', array( 'Bitmomo Pro adalah layanan decision support untuk BTC yang membantu memahami skenario berikutnya, kondisi yang membatalkan tesis utama, dan perubahan sejak analisis sebelumnya.', 'Pro melengkapi BTC Intelligence gratis dengan Expected Range, Scenario Map, kondisi invalidasi tesis, What Changed, dan fitur Pro lainnya.' ) ),
					self::q( 'free-vs-pro', 'Apa bedanya BTC Intelligence gratis dengan Bitmomo Pro?', array( 'BTC Intelligence gratis menjawab:', '“Apa yang sedang terjadi sekarang?”', 'Bitmomo Pro melangkah lebih jauh untuk membantu menjawab:', '“Skenario apa yang perlu dipantau?”<br>“Kondisi apa yang membatalkan tesis?”<br>“Apa yang berubah?”' ) ),
