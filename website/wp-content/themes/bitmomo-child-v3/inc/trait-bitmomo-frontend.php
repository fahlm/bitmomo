...
trait Bitmomo_Frontend_Trait {
    ...
    public function render_mailpoet_modal() {
        ...
        // Launch-critical product surfaces have one primary job: help visitors
        // understand BTC Intelligence / Pro and move toward the founding
        // whitelist. The legacy publisher-style newsletter modal is suppressed
        // on the homepage and dedicated product pages so it cannot compete with
        // the canonical conversion and retention paths.
        if (is_front_page() || is_page(['pro', 'btc-intelligence'])) return;
