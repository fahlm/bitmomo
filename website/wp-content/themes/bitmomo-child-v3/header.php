...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<a class="bm-skip-link" href="#primary"><?php esc_html_e('Lewati ke konten', 'bitmomo'); ?></a>
...
<header class="bm-header">
  <div class="bm-container">
    ...
    <nav class="bm-nav" id="bm-nav" aria-label="<?php esc_attr_e('Primary', 'bitmomo'); ?>">
      ...
      $bm_is_research = is_category('riset') || is_tag('ai-lab') || (is_single() && (has_category('riset') || has_tag('ai-lab')));
      ?>
      <div class="bm-nav-groups">
        <ul class="bm-nav-list bm-nav-list--content">
          ...
          <li><a href="<?php echo esc_url($bm_riset_url); ?>"<?php echo $bm_is_research ? ' aria-current="page"' : ''; ?>>Research</a></li>
