    ...
    <nav class="bm-nav" id="bm-nav" aria-label="<?php esc_attr_e('Primary', 'bitmomo'); ?>">
      ...
      <div class="bm-nav-groups">
        ...
        <ul class="bm-nav-list bm-nav-list--actions">
          <li><a class="bm-nav-login" href="<?php echo esc_url( $bm_account_url ); ?>"<?php echo $bm_is_account ? ' aria-current="page"' : ''; ?>>Masuk</a></li>
...
<?php unset( $bm_riset_term, $bm_riset_url, $bm_about_page, $bm_about_url, $bm_account_page, $bm_account_url, $bm_is_account, $bm_is_research ); ?>
