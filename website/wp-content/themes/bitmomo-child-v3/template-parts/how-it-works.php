  ...
  <div class="bm-container">
    ...
    <ol class="bm-howworks-steps">
      ...
      <li class="bm-howworks-step--future">
        <span class="bm-howworks-step-label"><?php esc_html_e( 'Watchtower', 'bitmomo' ); ?> <span class="bm-future-badge"><?php esc_html_e( 'IN DEVELOPMENT', 'bitmomo' ); ?></span></span>
    ...
    <div class="bm-howworks-future">
      <header class="bm-future-head">
        <span class="bm-future-eyebrow"><?php esc_html_e( 'BITMOMO PRO · IN DEVELOPMENT', 'bitmomo' ); ?></span>
      ...
      <ul class="bm-future-list" aria-label="<?php esc_attr_e( 'Fitur yang sedang dikembangkan', 'bitmomo' ); ?>">
        <li><span class="bm-future-badge"><?php esc_html_e( 'IN DEVELOPMENT', 'bitmomo' ); ?></span><span class="bm-future-name"><?php esc_html_e( '11 AI Analysts', 'bitmomo' ); ?></span></li>
        <li><span class="bm-future-badge"><?php esc_html_e( 'IN DEVELOPMENT', 'bitmomo' ); ?></span><span class="bm-future-name"><?php esc_html_e( 'Watchtower', 'bitmomo' ); ?></span></li>
