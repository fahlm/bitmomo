<?php
/** Compact homepage product model in visitor language. @package Bitmomo */
...
<section class="bm-section bm-howworks" aria-labelledby="bm-howworks-title">
  <div class="bm-container">
    <header class="bm-howworks-head">
      ...
      <h2 id="bm-howworks-title"><?php esc_html_e( 'Dari data pasar menjadi intelligence yang bisa diuji.', 'bitmomo' ); ?></h2>
    </header>
    ...
    <ol class="bm-howworks-steps">
      ...
      <li>
        ...
        <p><?php esc_html_e( 'BTC Intelligence menjelaskan kondisi sekarang. Pro menambahkan skenario, rentang yang dipantau, dan kondisi yang mengubah pandangan.', 'bitmomo' ); ?></p>
      </li>
      <li>
