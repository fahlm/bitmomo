...
<section class="bm-about-authority" aria-labelledby="bm-about-authority-title">
  <p class="bm-about-authority__eyebrow">RISET &amp; INTELLIGENCE</p>
  ...
  <div class="bm-about-authority__grid" aria-label="Output Bitmomo">
    ...
    <article>
      ...
      <p>Publikasi yang menguji struktur pasar, derivatif, likuiditas, volatilitas, makro, arus modal, serta sistem analisis yang digunakan untuk memahami BTC.</p>
    </article>
    <article>
      <span>03 · DUKUNGAN KEPUTUSAN</span>
      <h3>Bitmomo Pro</h3>
      <p>Pemantauan lengkap, Expected Range, Scenario Map, dan invalidasi tesis untuk membantu menavigasi apa yang terjadi berikutnya dan kapan tesis pasar perlu dievaluasi ulang.</p>
    </article>
  </div>
</section>
...
<section class="bm-about-principles" aria-labelledby="bm-about-principles-title">
  <header>
    <p class="bm-about-authority__eyebrow">STANDAR RISET</p>
...
<section class="bm-about-product" aria-labelledby="bm-about-product-title">
  <div>
    <p class="bm-about-authority__eyebrow">DARI RISET KE PRODUK</p>
    <h2 id="bm-about-product-title">Gratis membantu memahami sekarang. Pro membantu menavigasi berikutnya.</h2>
    <p>BTC Intelligence merangkum kondisi BTC, perubahan material, mengapa perubahan itu penting, dan satu konteks pantauan. Bitmomo Pro memperluasnya dengan pemantauan lengkap, Expected Range, Scenario Map, dan kondisi invalidasi tesis.</p>
